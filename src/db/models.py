...
class LogAnalysisLLMCall(DatabaseModel):
    ...
    provider_name = fields.CharField(max_length=80, null=True)
    model_name = fields.CharField(max_length=160, null=True)
    ...
    request_character_count = fields.IntField(null=True)
    usage_raw: fields.JSONField[dict[str, Any] | None] = fields.JSONField(null=True)
